          ...
          <div>
            ...
            {(() => {
              ...
              const ongoingExams = exams.filter((exam) => {
                const examDateTime = new Date(exam.scheduledDate);
                ...
                return examDateTime <= now && now <= examEndTime;
              });

              if (ongoingExams.length > 0) {
                return (
                  <div style={{ marginBottom: '40px' }}>
                    <h3 style={{ color: '#10b981', marginBottom: '20px' }}>🔴 Ongoing Exams</h3>
                            ...
                            <tr key={exam._id}>
                              ...
                              <td>
                                <div className="flex-wrap">
                                  ...
                                  <button
                                    onClick={() => navigate(`/teacher/exam/${exam._id}/manage`)}
            ...
            {(() => {
              ...
              if (upcomingExams.length > 0) {
                return (
                  <div style={{ marginBottom: '40px' }}>
                    <h3 style={{ color: '#f59e0b', marginBottom: '20px' }}>🟡 Upcoming Exams</h3>
                    <div style={{ overflowX: 'auto' }}>
                      <table className="table">
                        <thead>
                          <tr>
            ...
            {(() => {
              ...
              if (completedExams.length > 0) {
                return (
                  <div>
                    <h3 style={{ color: '#6b7280', marginBottom: '20px' }}>✅ Completed Exams</h3>
                    <div style={{ overflowX: 'auto' }}>
                      <table className="table">
                        <thead>
                          <tr>
