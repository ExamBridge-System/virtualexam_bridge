                  ...
                  {submissions.map((submission) => (
                    ...
                    >
                      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                        <div>
                          <strong style={{ color: submission.exchangeCount > 0 ? '#dc2626' : 'inherit' }}>
                      ...
                      <p style={{ color: '#718096', fontSize: '13px', marginTop: '8px' }}>
                        ...
                        {submission.exchangeCount > 0 && <span style={{ color: '#dc2626', fontWeight: 'bold' }}> | Exchanged {submission.exchangeCount} time{submission.exchangeCount > 1 ? 's' : ''}</span>}
                      </p>
                    </div>
                  ))}
                </div>
